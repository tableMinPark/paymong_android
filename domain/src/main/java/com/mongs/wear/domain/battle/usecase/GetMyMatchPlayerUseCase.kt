...
import com.mongs.wear.core.exception.usecase.GetMyMatchUseCaseException
...
class GetMyMatchPlayerUseCase @Inject constructor(
    ...
    override fun handleException(exception: DataException) {
        ...
        when(exception) {
            is NotExistsMatchPlayerException -> throw GetMyMatchUseCaseException()

            else -> throw GetMyMatchUseCaseException()
        }
    }
}